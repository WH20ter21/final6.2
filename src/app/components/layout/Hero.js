            ...
            <div className="hero max-w-4xl mx-auto p-4 mt-6 z-40">
                <div className="py-7">
                    <h1 className="text-4xl font-semibold leading-12">
                        &ldquo;Satisfy Your Cravings, <span className="text-primary">One Click Away!</span>&rdquo;
                    </h1>
                    <p className="my-4 text-gray-500"> 
                        &ldquo;Leveraging Technology to Showcase and Preserve 
                        Local Culinary Heritage&rdquo;
                    </p>
